...
<button onClick={()=>handleForgetpassword(userEmail)} className='border  rounded-2xl bg-blue-600 text-white text-sm md:text-base p-2.5 md:p-2 hover:bg-blue-100'>Forgot password??</button>
